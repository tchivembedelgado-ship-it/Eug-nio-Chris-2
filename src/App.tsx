...
function ProtectedRoute({ children, adminOnly = false, requireProfile = true }: { children: React.ReactNode, adminOnly?: boolean, requireProfile?: boolean }) {
  ...
  if (requireProfile && !profile?.is_admin) {
    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-black p-4 text-center text-white">
        <div className="max-w-md space-y-6 rounded-[2.5rem] border border-white/10 bg-zinc-900 p-10 shadow-2xl">
          <h2 className="text-3xl font-black tracking-tighter text-emerald-500">Configuração Necessária</h2>
          <p className="text-zinc-400">
            Para colocar a RifaAngola a funcionar, precisa de configurar o Supabase.
          </p>
          <div className="space-y-4 text-left text-sm">
            <p><strong>1.</strong> Crie um projeto em <a href="https://supabase.com" target="_blank" className="text-emerald-500 underline">supabase.com</a></p>
        ...
        <div className="min-h-screen bg-black text-white selection:bg-emerald-500 selection:text-black">
          ...
          <footer className="border-t border-white/5 bg-zinc-900/30 py-12">
            <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
              <div className="mb-8 text-2xl font-bold tracking-tighter text-emerald-500">
                RIFA<span className="text-white">ANGOLA</span>
              </div>
              <p className="text-sm text-zinc-500">
                © 2026 RifaAngola. Todos os direitos reservados. Jogue com responsabilidade.
              </p>
            </div>
          </footer>
        </div>
